...
import $file.scripts.utils.SimpleJSDepsBuild, SimpleJSDepsBuild.SimpleJSDeps
...
object utils extends Module {
  ...
  override def millSourcePath = build.millSourcePath / "utils"
  ...
  object `model-gen` extends FullJvmModule {
    override def millSourcePath = super.millSourcePath / "model-gen"
  }
